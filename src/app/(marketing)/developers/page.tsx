    ...
    <div className="min-h-screen bg-white dark:bg-slate-950">
      <nav className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/90 backdrop-blur-md dark:border-slate-800 dark:bg-slate-950/90">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
          ...
          >
            <TabiLogo className="h-9 w-auto text-brand-600 dark:text-white" />
          </Link>
          <div className="flex items-center gap-4">
            ...
            <Link
              ...
              className="hidden text-sm text-slate-600 hover:text-slate-900 sm:inline dark:text-slate-400"
            >
              Sign in
            </Link>
            <Link
      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        ...
        <p className="mt-4 text-lg text-slate-600 dark:text-slate-400">
          Start with the <strong>public docs</strong>: quick start, auth,
          copy-paste examples, then the full endpoint list. After sign-in, the
          dashboard adds <strong>Try it out</strong> and webhook tools; super
        ...
        <ul className="mt-12 space-y-6">
          <li className="flex gap-4 rounded-2xl border border-slate-200 bg-slate-50/80 p-6 dark:border-slate-800 dark:bg-slate-900/40">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">
                No login. Guides (quick start, authentication, webhooks),
                ready-to-run curl and HTTP examples, a &quot;coming soon&quot;
          ...
          <li className="flex gap-4 rounded-2xl border border-slate-200 bg-slate-50/80 p-6 dark:border-slate-800 dark:bg-slate-900/40">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">
                After sign-in: <strong>Developer</strong> role sees the
                integration catalog with <strong>Try it out</strong>.{" "}
                <strong>Owner / Admin</strong> see every tenant endpoint (still
                no platform-wide operator routes).
              </p>
              <Link
                href={dashboardUrl("/login")}
          ...
          <li className="flex gap-4 rounded-2xl border border-slate-200 bg-slate-50/80 p-6 dark:border-slate-800 dark:bg-slate-900/40">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">
                Super admins get the <strong>complete</strong> OpenAPI document,
                including platform administration APIs, from the admin area
                after sign-in.
              </p>
            </div>
          </li>
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-200 p-4 dark:border-slate-800">
            ...
            <p className="mt-1 text-xs text-slate-600 dark:text-slate-400">
              JWT from login for dashboard flows; scoped API keys per workspace
              or channel for server-to-server calls.
            </p>
          </div>
          <div className="rounded-xl border border-slate-200 p-4 dark:border-slate-800">
            ...
            <p className="mt-1 text-xs text-slate-600 dark:text-slate-400">
              Subscribe to inbound messages and delivery events; signed payloads
              to your HTTPS endpoints.
            </p>
          </div>
          <div className="rounded-xl border border-slate-200 p-4 dark:border-slate-800">
