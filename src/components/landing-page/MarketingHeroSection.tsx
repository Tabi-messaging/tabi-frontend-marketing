  ...
  return (
    <section className=" grid place-items-center  max-w-5xl mx-auto px-4 py-32  md:py-20 lg:pt-32">
      <div className="text-center space-y-6 mb-6">
        ...
        <p className="leading-relaxed md:w-[60%] mx-auto tracking-normal text-text-muted text-xl sm:leading-7.5 md:leading-snug ">
      ...
      <div className="mb-4 flex flex-wrap items-start justify-center gap-4 px-4">
        <div>
          <Link href={dashboardUrl("/register")} prefetch={false}>
            <Button className=" rounded-full bg-primary px-12 py-6 text-base font-medium text-white hover:bg-button-purple-hover">
              Start for free
            </Button>
          </Link>

          <p className="text-center text-xs mt-2 font-normal tracking-normal text-text-muted sm:text-base ">
            7 days free trial
          </p>
        </div>
        ...
        <Link href="/api-docs">
          <Button
            variant="outline"
            className=" text-black inline-flex items-center gap-2.5 rounded-full border border-solid border-border-light-interactive bg-white  px-8 py-6 text-base font-medium"
          >
            Watch Demo
