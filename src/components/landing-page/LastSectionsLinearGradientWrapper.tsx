...
export default function LastSectionsLinearGradientWrapper({
  ...
  return (
    <section id="pricing" className="relative w-full overflow-hidden">
      ...
      <div
        className="pointer-events-none absolute inset-0 bg-linear-to-b from-white via-section-light-gradient-1 to-section-light-gradient-2"
        aria-hidden
      />
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        */}
        <div className="absolute left-1/2 top-0 -translate-x-1/2 w-[150vw] h-[150vh] md:-left-96 md:translate-x-0 md:h-676.75 md:w-505.5">
          ...
          <div className="absolute left-[15%] top-[30%] h-full w-[80%] rounded-full bg-gradient-purple-dark-2 blur-[100px] md:left-16.75 md:top-156.5 md:h-488.75 md:w-488.75 md:blur-[137.91px]" />

          <div className="absolute left-[15%] top-[40%] h-full w-[80%] rounded-full bg-section-dark-secondary blur-[100px] md:left-16.75 md:top-188 md:h-488.75 md:w-488.75 md:blur-[137.91px]" />
        </div>
      </div>
